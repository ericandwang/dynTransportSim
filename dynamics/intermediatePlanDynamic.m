...
if (type == 1)
    ...
    Aline2 = [-boundarySlopes(3) -1; boundarySlopes(3) -1; boundarySlopes(1) -1];
    bline2 = -[boundaryPoints(2,1)-(-boundarySlopes(3))*boundaryPoints(1,1); ...
              boundaryPoints(2,2)-boundarySlopes(3)*boundaryPoints(1,2); ...
              boundaryPoints(2,1)-boundarySlopes(1)*boundaryPoints(1,1)];
    Aline1 = [-boundarySlopes(3) -1; boundarySlopes(3) -1; boundarySlopes(2) -1];
    bline1 = -[boundaryPoints(2,3)-(-boundarySlopes(3))*boundaryPoints(1,3); ...
              boundaryPoints(2,4)-boundarySlopes(3)*boundaryPoints(1,4); ...
              boundaryPoints(2,1)-boundarySlopes(2)*boundaryPoints(1,1)];
end
...
% Plotting gravito inertial wrench constraints for type -1
if (type == -1)
    figure(200)
    hold off
    stretch = 4;
...
vy(1) = dy0;
for i = 1:length(x)-1
    x(i+1) = x(i) + vx(i)*dt + 1/6*(2*ax(i)+ax(i+1))*dt^2;
